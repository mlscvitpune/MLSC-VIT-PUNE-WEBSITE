...
import Blockchain from '../Team/Team_Card_Elements/cyber2.png';
  ...
  return (
    <div>
      ...
      <div className="cards-list">
        ...
        <Link className="card 12" to="blockchain" smooth={true} duration={300}>
          <div className="card_image">
            <div className="card_image">
              <img src={Blockchain} alt="Blockchain" />
              <div className="image_overlay image_overlay--primary">
                <div className="image_title">Blockchain</div>
              </div>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="card_image">
            <div className="card_image">
              <img src={Content} alt="Content and Multimedia" />
              <div className="image_overlay image_overlay--primary">
                <div className="image_title">Content and Multimedia</div>
              </div>
            </div>
          </div>
        </Link>
