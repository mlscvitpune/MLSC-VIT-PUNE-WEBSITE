...
function ManagementMarketing() {
  return (
    <div>
      <div className="our-team pt-2" id="mangementmarketing">
        Management
      </div>
      <div className="row">
    ...
    <div className="row">  
      ...
      <div className="row">  
        <div className="your-element col-12 col-md-4 text-center py-4">
          ...
          >
            <div className="member-image m38 mx-auto"></div>
            <div className="hover_3d pt-3">
              <div className="name">Rushikesh Mali</div>
              <div className="position">Co-ordinator</div>
              <div>
                <ul className="list-inline">
                  <li className="list-inline-item social-icons">
                    <a href="https://twitter.com/RushikeshM05">
                      <i className="fab fa-twitter"></i>
                    </a>
                  </li>
                  <li className="list-inline-item social-icons">
                    <a href="https://www.linkedin.com/in/rushikesh-mali-1a30a5222/">
                      <i className="fab fa-linkedin"></i>
                    </a>
                  </li>
                 <li className="list-inline-item social-icons">
                    <a href="https://github.com/RushikeshMali05">
                      <i className="fab fa-github"></i>
                    </a>
                  </li> 
                </ul>
          ...
          >
            <div className="member-image m39 mx-auto"></div>
            <div className="hover_3d pt-3">
              <div className="name">Komalesh Patil</div>
              <div className="position">Co-ordinator</div>
              <div>
                <ul className="list-inline">
                  <li className="list-inline-item social-icons">
                    <a href="https://twitter.com/KomaleshPatil?t=Wn-CnGsjZDXylA4Ti1maUw&s=09">
                      <i className="fab fa-twitter"></i>
                    </a>
                  </li>
                  <li className="list-inline-item social-icons">
                    <a href="https://www.linkedin.com/in/komalesh-patil-34a26b20b">
                      <i className="fab fa-linkedin"></i>
                    </a>
                  </li>
              <li className="list-inline-item social-icons">
                    <a href="https://github.com/komaleshdpgit">
                      <i className="fab fa-github"></i>
                    </a>
                  </li>
                </ul>
          ...
          >
            <div className="member-image m40 mx-auto"></div>
            <div className="hover_3d pt-3">
              <div className="name">Prathamesh Londhe</div>
              <div className="position">Co-ordinator</div>
              <div>
                <ul className="list-inline">
                  <li className="list-inline-item social-icons">
                    <a href="https://twitter.com/Pratham44372550">
                      <i className="fab fa-twitter"></i>
                    </a>
                  </li>
                  <li className="list-inline-item social-icons">
                    <a href="https://www.linkedin.com/in/prathamesh-londhe-b12a4522a/">
                      <i className="fab fa-linkedin"></i>
                    </a>
                  </li>
                  <li className="list-inline-item social-icons">
                    <a href="https://github.com/Prathamesh07041">
                      <i className="fab fa-github"></i>
                    </a>
                  </li>
                </ul>
...
export default ManagementMarketing;
