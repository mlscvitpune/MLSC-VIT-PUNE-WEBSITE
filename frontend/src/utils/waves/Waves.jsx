...
const Waves =()=>{
    return(
        ...
        <path className = "waves" style={{animationDuration: "4s"}} d="M0 229L82 157L164 205L245 187L327 133L409 127L491 169L573 199L655 199L736 223L818 181L900 193L900 149L818 89L736 179L655 143L573 143L491 89L409 53L327 65L245 77L164 155L82 59L0 143Z" fill="#dbe9fe">
            </path>
